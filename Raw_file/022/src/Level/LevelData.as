package Level 
{
	...
	public class LevelData extends Sprite
	{
		...
		public function setLevel( lvl:Number ):Array {
			...
			switch( lvl ) {
				case 1:
					arrData	= [ { state: 1, label: "toy", name:"toy", maxNum: 5 },
								{ state: 1, label: "toy", name:"2"},
								{ state: 0, label: "girly", name:"3"},
								{ state: 0, label: "random", name:"4"},
								{ state: 0, label: "toy", name:"5"},
								{ state: 0, label: "food", name:"6"},
				...
				break;
			case 2:
					arrData	= [ { state: 1, label: "toy", name:"toy" , maxNum: 7 },
								{ state: 1, label: "food", name:"2"},
								{ state: 1, label: "girly", name:"3"},
				...
				break;
			case 3:
					arrData	= [ { state: 1, label: "toy", name:"toy" , maxNum: 9 },
								{ state: 1, label: "food", name:"2"},
			...
			case 4:
					arrData	= [ { state: 1, label: "toy", name:"toy" , maxNum: 11 },
								{ state: 1, label: "food", name:"2"},
								{ state: 1, label: "extra", name:"3"},
								{ state: 1, label: "toy", name:"4"},
								{ state: 1, label: "food", name:"5"},
			...
			case 5:
					arrData	= [ { state: 1, label: "toy", name:"toy" , maxNum: 12},
								{ state: 1, label: "food", name:"2"},
								{ state: 1, label: "extra", name:"3"},
								{ state: 1, label: "toy", name:"4"},
								{ state: 1, label: "food", name:"5"},
			...
			case 6:
					arrData	= [ { state: 1, label: "toy", name:"toy" , maxNum: 13},
								{ state: 1, label: "food", name:"2"},
								{ state: 1, label: "extra", name:"3"},
								{ state: 1, label: "toy", name:"4"},
								{ state: 1, label: "food", name:"5"},
			...
			case 7:
					arrData	= [ { state: 1, label: "toy", name:"toy" , maxNum: 15},
								{ state: 1, label: "food", name:"2"},
								{ state: 1, label: "extra", name:"3"},
								{ state: 1, label: "toy", name:"4"},
								{ state: 1, label: "food", name:"5"},
			...
			case 8:
					arrData	= [ { state: 1, label: "toy", name:"toy" , maxNum: 17},
								{ state: 1, label: "food", name:"2"},
								{ state: 1, label: "extra", name:"3"},
								{ state: 1, label: "toy", name:"4"},
								{ state: 1, label: "food", name:"5"},
			...
			case 9:
					arrData	= [ { state: 1, label: "toy", name:"toy" , maxNum: 19},
								{ state: 1, label: "food", name:"2"},
								{ state: 1, label: "extra", name:"3"},
								{ state: 1, label: "toy", name:"4"},
								{ state: 1, label: "food", name:"5"},
			...
			case 10:
					arrData	= [ { state: 1, label: "toy", name:"toy" , maxNum: 21},
								{ state: 1, label: "food", name:"2"},
								{ state: 1, label: "extra", name:"3"},
								{ state: 1, label: "toy", name:"4"},
								{ state: 1, label: "food", name:"5"},
								...
								{ state: 1, label: "food", name:"8"},
								{ state: 1, label: "extra", name:"9"},
								{ state: 1, label: "toy", name:"3"},
								{ state: 1, label: "food", name:"2"},
								{ state: 1, label: "extra", name:"1"}
							  ];
				break;
			}
			return arrData;
