...
{	
	...
	public class MapManager extends Sprite
	{
		...
		public function addGlobalListener():void {
			...
			this.addEventListener("ON_DONE", onTriggerDoneBtn);
		}
		
		private function onTriggerDoneBtn(e:Event):void 
		{
			ctr++;
			trace("On Map manager");
			itemList.setrefList = levelData.setLevel(ctr);
		}
