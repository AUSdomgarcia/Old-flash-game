package  
{
	...
	public class GameView extends Sprite
	{
		...
		private function init():void {
			...
			gameEngine.setCurrentBonus( charData.currBonusPoints );
		}
		private function addListener():void 
		{
			...
			this.addEventListener( GameEvent.ON_ADD_STACK_POINTS, onAddStackBonusPoints );
			this.addEventListener( GameEvent.ON_UPDATE_STACK_POINTS, onUpdateStackPoints );
		}
		
		private function onAddStackBonusPoints(e:GameEvent):void 
		{
			charData.updateAddBonusPoints();
			gameEngine.setCurrentBonus( charData.currBonusPoints );
		}
		private function onUpdateStackPoints(e:GameEvent):void 
		{
			charData.updateMinusBonusPoints();
			gameEngine.setCurrentBonus( charData.currBonusPoints );
		}
